...
<%-- 				<img src="c:/upload/<%=product.getFilename()%>" style="width: 100%" /> --%>
				<img alt="" src="${pageContext.request.contextPath}/resources/images/<%=product.getFilename()%>" style="width:100%; height:50%">
			...
			<div class="col-md-6">
				...
				<p><form name="addForm" action="./addCart.jsp?id=<%=product.getProductId()%>" method="post">
					<input type="text" name="cartQuantity" placeholder="구매수량" style="width:100%"/>
